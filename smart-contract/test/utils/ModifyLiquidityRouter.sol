...
/// @notice Test router that calls modifyLiquidity from within the unlock callback (Uniswap v4-style).
/// Implements settlement and transfer like v4-core: settle negative deltas, take positive deltas.
